...
Markup : 1.  Determine the number of players (2-4)
Markup : 2.  Open one terminal for the server and a terminal for each player (can be on separate computers)
Markup : 3.  In the server terminal, enter: ./gradlew :server:run --args "4444 \[number of players]"
Markup : 4.  In each player terminal, enter: ./gradlew : client:run --args "\[server name] 4444"
Markup : 5.  Follow in-game instructions to play game
